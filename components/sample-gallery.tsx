...
const SAMPLES = [
  ...
  },
  {
    ...
    preview:
      "Before you send another proposal, check these. Section 1: Discovery. Did you confirm budget tier? Did you ask about decision-maker? Did you…",
  ...
  },
  {
    ...
    accent: "from-orange-500/40 to-pink-600/30",
  },
  {
    icon: Layout,
  ...
  },
  {
    ...
    accent: "from-blue-500/40 to-cyan-600/30",
  },
  {
    icon: FileText,
    format: "Ultimate Guide",
    ...
    accent: "from-violet-500/30 to-orange-500/30",
  },
];
  ...
  return (
    <section id="examples" className="relative py-16 md:py-24 px-4 scroll-mt-20">
      <div className="max-w-6xl mx-auto">
        ...
        >
          <div className="text-xs font-semibold uppercase tracking-widest text-[var(--color-accent-violet)] mb-3">
            Examples
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-5">
          {SAMPLES.map((s, i) => (
            ...
            >
              ...
              <div className="text-[10px] uppercase tracking-widest text-[var(--color-text-dim)] mb-1.5 font-semibold">
                {s.format} · {s.audience}
              </div>
              <h3 className="text-base font-bold leading-snug mb-3 line-clamp-2">
                {s.title}
              </h3>
